...
export default function GameSelection() {
  ...
  return (
    <section className="container mx-auto px-4 pb-12">
      <p className="text-4xl md:text-6xl tracking-tighter font-bold font-source-sans bg-gradient-to-r from-[#DEDCFF] to-[#6f58ff] bg-clip-text text-transparent mb-8 md:mb-12 text-center">
        {t('choose-your-game')}
      </p>
