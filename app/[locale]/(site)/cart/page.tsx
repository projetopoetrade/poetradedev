  ...
  return (
    <div className="flex flex-col min-h-screen">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2">
                            <h3 className="font-medium text-sm md:text-base line-clamp-2">{item.product.name}</h3>
                          ...
                          <div className="flex items-center gap-1.5 md:gap-2 mt-2">
                            ...
                            <Input
                              ...
                              className="w-12 md:w-16 h-7 md:h-9 text-xs md:text-sm text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                            />
                            <Button
                              variant="outline"
                              size="icon"
      ...
      <PixQRCodeModal
        ...
        onGenerateNewPix={() => {
          // Reabrir o formulário PIX para gerar um novo QR code
