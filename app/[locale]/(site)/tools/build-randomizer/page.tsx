                ...
                <div className="lg:col-span-1 border border-gray-800 bg-gray-900/40 p-6 rounded-xl space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-sm font-medium text-gray-300">Game Version</label>
                            <Select disabled={isControlsDisabled} value={gameVersion} onValueChange={setGameVersion}>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Select disabled={isControlsDisabled} value={poeClass} onValueChange={setPoeClass}>
                                <SelectTrigger className="w-full bg-black/40 border-gray-700/50">
                        ...
                        {ascendancies.length > 0 && (
                            <div className="space-y-1.5">
                                <label className="text-sm font-medium text-gray-300">Ascendancy</label>
                                <Select disabled={isControlsDisabled} value={ascendancy} onValueChange={setAscendancy}>
                                    <SelectTrigger className="w-full bg-black/40 border-gray-700/50">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Select disabled={isControlsDisabled} value={difficulty} onValueChange={setDifficulty}>
                                <SelectTrigger className="w-full bg-black/40 border-gray-700/50">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Select disabled={isControlsDisabled} value={budget} onValueChange={setBudget}>
                                <SelectTrigger className="w-full bg-black/40 border-gray-700/50">
                            ...
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center space-x-2 bg-amber-500/10 p-2.5 rounded border border-amber-500/20">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => setOnlyLeagueStarters(checked === true)}
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {BUILD_TAGS.filter(t => t.value !== 'league-starter').map((tag) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                disabled={isControlsDisabled}
                                                className={`text-xs px-2.5 py-1 rounded-full border transition-all disabled:opacity-50 ${active
                    ...
                    {status === "loading" && (
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-gray-400 animate-pulse">
                                {locale === "pt-br" ? "Buscando builds..." : "Fetching builds..."}
                            </p>
                        </div>
                    )}
                        ...
                        <div className="w-full max-w-sm mx-auto flex flex-col items-center animate-in fade-in zoom-in duration-500">
                            ...
                            <div className="w-full bg-amber-500/10 border-x border-b border-amber-500/50 p-4 rounded-b-xl flex justify-center mt-[-4px] z-10">
                                ...
                                >
                                    ...
                                    {locale === "pt-br" ? "Ver Detalhes da Build" : "View Build Details"}
                                </Link>
                            </div>
                        </div>
                    )}
                        ...
                        >
                            ...
                            {status !== "animating" && (
                                <span className="flex items-center gap-3">
                                    ...
                                    {status === "finished"
                                        ? (locale === "pt-br" ? "Sortear Novamente" : "Roll Again")
                                        : (locale === "pt-br" ? "Sortear Build" : "Roll Build")}
                                </span>
                            )}
                        </button>
                    </div>
            ...
            <div className="mt-20 border-t border-gray-800 pt-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-white mb-6">
                        {locale === "pt-br" ? "Perguntas Frequentes (FAQ)" : "Frequently Asked Questions (FAQ)"}
                    </h2>
